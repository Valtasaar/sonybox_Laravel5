...
function scaleBannerVideoSize(t) {
    var n, o, e = $(window).width(), i = $(window).height() + 5;
    $(t).each(function() {
...
jQuery.easing.jswing = jQuery.easing.swing,
    jQuery.extend(jQuery.easing, {
        ...
        easeInOutBack: function(t, e, i, n, o, a) {
            return void 0 == a && (a = 1.70158),
                (e /= o / 2) < 1 ? n / 2 * (e * e * (((a *= 1.525) + 1) * e - a)) + i : n / 2 * ((e -= 2) * e * (((a *= 1.525) + 1) * e + a) + 2) + i
        },
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity,
        ...
        if (!t.jQuery) {
            ...
            i.isWindow = function(t) {
                ...
                i.each = function(t, i, n) {
                    var o, a = 0, s = t.length, r = e(t);
                    if (n) {
                        if (r)
                            for (; s > a && (o = i.apply(t[a], n),
                            o !== !1); a++)
                                ;
                        else
                            for (a in t)
                        ...
                        for (; s > a && (o = i.call(t[a], a, t[a]),
                        o !== !1); a++)
                            ;
                    else
                        for (a in t)
                            if (o = i.call(t[a], a, t[a]),
                                o === !1)
                                break;
                    return t
                }
                ...
                ,
                i.extend = function() {
                    var t, e, n, o, a, s, r = arguments[0] || {}, l = 1, c = arguments.length, u = !1;
                    for ("boolean" == typeof r && (u = r,
                        ...
                        if (null != (a = arguments[l]))
                            for (o in a)
                                t = r[o],
                                    n = a[o],
                                r !== n && (u && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1,
                                    s = t && i.isArray(t) ? t : []) : s = t && i.isPlainObject(t) ? t : {},
                                    r[o] = i.extend(u, s, n)) : void 0 !== n && (r[o] = n));
                    return r
                }
                ,
                i.queue = function(t, n, o) {
                    ...
                    if (t) {
                        n = (n || "fx") + "queue";
                        var s = i.data(t, n);
                        return o ? (!s || i.isArray(o) ? s = i.data(t, n, a(o)) : s.push(o),
                            s) : s || []
                    }
                }
                ,
            ...
            i.expando = "velocity" + (new Date).getTime(),
                i.uuid = 0;
            for (var o = {}, a = o.hasOwnProperty, s = o.toString, r = "Boolean Number String Function Array Date RegExp Object Error".split(" "), l = 0; l < r.length; l++)
        ...
        function(t) {
            ...
            return function(t, e, i, n) {
                ...
                function l(t, i, n, o) {
                    ...
                    function f(e) {
                        for (var i = 0, o = 1, a = b - 1; o != a && k[o] <= e; ++o)
                            i += w;
                        --o;
                    ...
                    var k = x ? new Float32Array(b) : new Array(b)
                        ...
                        , P = function(e) {
                            return S || p(),
                                t === i && n === o ? e : 0 === e ? 0 : 1 === e ? 1 : l(f(e), i, o)
                        };
                ...
                function c(t, e) {
                    var i = t;
                    return m.isString(t) ? b.Easings[t] || (i = !1) : i = m.isArray(t) && 1 === t.length ? r.apply(null, t) : m.isArray(t) && 2 === t.length ? w.apply(null, t.concat([e])) : m.isArray(t) && 4 === t.length ? l.apply(null, t) : !1,
                            ...
                            if (b.State.calls[a]) {
                                ...
                                for (var g = Math.min((e - f) / c.duration, 1), y = 0, w = l.length; w > y; y++) {
                                    ...
                                    if (s(S)) {
                                        ...
                                        for (var A in C)
                                            if ("element" !== A) {
                                                var E, M = C[A], I = m.isString(M.easing) ? b.Easings[M.easing] : M.easing;
                                                if (1 === g)
                                                    E = M.endValue;
                                                else {
                                                    var O = M.endValue - M.startValue;
                                                    if (E = M.startValue + O * I(g, c, O),
                                                        !p && E === M.currentValue)
                                                        continue
                                                }
                                                if (M.currentValue = E,
                                                    ...
                                                    x.Hooks.registered[A] && (s(S).rootPropertyValueCache[F] = x.Normalizations.registered[F] ? x.Normalizations.registered[F]("extract", null, D[1]) : D[1]),
                                                    "transform" === D[0] && (P = !0)
                                                }
                                            }
                                        c.mobileHA && s(S).transformCache.translate3d === n && (s(S).transformCache.translate3d = "(0px, 0px, 0px)",
                                            P = !0),
                                        P && x.flushTransformCache(S)
                                    }
                                }
                                c.display !== n && "none" !== c.display && (b.State.calls[a][2].display = !1),
                                c.visibility !== n && "hidden" !== c.visibility && (b.State.calls[a][2].visibility = !1),
                                c.progress && c.progress.call(r[1], r[1], g, Math.max(0, f + c.duration - e), f, v),
                                1 === g && h(a)
                            }
                    }
                ...
                function h(t, e) {
                    ...
                    for (var i = b.State.calls[t][0], o = b.State.calls[t][1], a = b.State.calls[t][2], r = b.State.calls[t][4], l = !1, c = 0, u = i.length; u > c; c++) {
                        var h = i[c].element;
                        if (e || a.loop || ("none" === a.display && x.setPropertyValue(h, "display", a.display),
                            "hidden" === a.visibility && x.setPropertyValue(h, "visibility", a.visibility)),
                            a.loop !== !0 && (d.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(d.queue(h)[1])) && s(h)) {
                            s(h).isAnimating = !1,
                                s(h).rootPropertyValueCache = {};
                            var f = !1;
                            d.each(x.Lists.transforms3D, function(t, e) {
                                var i = /^scale/.test(e) ? 1 : 0
                                    , o = s(h).transformCache[e];
                                s(h).transformCache[e] !== n && new RegExp("^\\(" + i + "[^.]").test(o) && (f = !0,
                                    delete s(h).transformCache[e])
                            }),
                            a.mobileHA && (f = !0,
                                delete s(h).transformCache.translate3d),
                        ...
                        r && a.loop !== !0 && r(o),
                        s(h) && a.loop === !0 && !e && (d.each(s(h).tweensContainer, function(t, e) {
                ...
                var w = function() {
                    ...
                    return function n(t, e, o) {
                        ...
                        for (t = parseFloat(t) || 500,
                                 ...
                                 a = null !== o,
                                 a ? (u = n(t, e),
                                     s = u / o * d) : s = d; r = i(r || l, s),
                                 c.push(1 + r.x),
                                 u += 16,
                             Math.abs(r.x) > h && Math.abs(r.v) > h; )
                            ;
                        return a ? function(t) {
                ...
                var x = b.CSS = {
                    ...
                    Hooks: {
                            ...
                            if (f)
                                for (i in x.Hooks.templates) {
                                    ...
                                    "Color" === o[0] && (o.push(o.shift()),
                                        a.push(a.shift()),
                                        x.Hooks.templates[i] = [o.join(" "), a.join(" ")])
                                }
                            for (i in x.Hooks.templates) {
                                n = x.Hooks.templates[i],
                                    o = n[0].split(" ");
                        ...
                        injectValue: function(t, e, i) {
                            ...
                            if (n) {
                                var o, a, s = n[0], r = n[1];
                                return i = x.Hooks.cleanRootPropertyValue(s, i),
                                        ...
                                        switch (t) {
                                            ...
                                            case "inject":
                                                ...
                                                switch (e.substr(0, e.length - 1)) {
                                                    ...
                                                    case "scal":
                                                    case "scale":
                                                        b.State.isAndroid && s(i).transformCache[e] === n && 1 > o && (o = 1),
                                                            a = !/(\d)$/i.test(o);
                                                        break;
                                                    case "skew":
                                                        a = !/(deg|\d)$/i.test(o);
                                                ...
                                                return a || (s(i).transformCache[e] = "(" + o + ")"),
                                        ...
                                        switch (t) {
                                            ...
                                            case "extract":
                                                ...
                                                if (x.RegEx.wrappedValueAlreadyExtracted.test(o))
                                                    ...
                                                    /^[A-z]+$/i.test(o) ? s = r[o] !== n ? r[o] : r.black : x.RegEx.isHex.test(o) ? s = "rgb(" + x.Values.hexToRgb(o).join(" ") + ")" : /^rgba?\(/i.test(o) || (s = r.black),
                                                        a = (s || o).toString().match(x.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                                }
                                                return 8 >= f || 3 !== a.split(" ").length || (a += " 1"),
                                                    a;
                                            case "inject":
                    ...
                    getPropertyValue: function(t, i, o, a) {
                        function r(t, i) {
                            ...
                            if (8 >= f)
                                ...
                                var c = !1;
                                if (/^(width|height)$/.test(i) && 0 === x.getPropertyValue(t, "display") && (c = !0,
                        ...
                        if (x.Hooks.registered[i]) {
                            var c = i
                                , u = x.Hooks.getRoot(c);
                            o === n && (o = x.getPropertyValue(t, x.Names.prefixCheck(u)[0])),
                            x.Normalizations.registered[u] && (o = x.Normalizations.registered[u]("extract", t, o)),
                                l = x.Hooks.extractValue(c, o)
                        } else if (x.Normalizations.registered[i]) {
                            var h, p;
                            h = x.Normalizations.registered[i]("name", t),
                            "transform" !== h && (p = r(t, x.Names.prefixCheck(h)[0]),
                    ...
                    setPropertyValue: function(t, i, n, o, a) {
                        ...
                        if ("scroll" === i)
                            ...
                            if (x.Hooks.registered[i]) {
                                var l = i
                                    , c = x.Hooks.getRoot(i);
                                o = o || x.getPropertyValue(t, c),
                                    n = x.Hooks.injectValue(l, n, o),
                                    i = c
                            }
                ...
                var C = function() {
                    ...
                    function o() {
                        function t(t) {
                            function h(t, e) {
                                var i = n
                                    , o = n
                                    , s = n;
                                return m.isArray(t) ? (i = t[0],
                                    !m.isArray(t[1]) && /^[\d-]/.test(t[1]) || m.isFunction(t[1]) || x.RegEx.isHex.test(t[1]) ? s = t[1] : (m.isString(t[1]) && !x.RegEx.isHex.test(t[1]) || m.isArray(t[1])) && (o = e ? t[1] : c(t[1], r.duration),
                                    t[2] !== n && (s = t[2]))) : i = t,
                                e || (o = o || r.easing),
                                m.isFunction(i) && (i = i.call(a, S, k)),
                                m.isFunction(s) && (s = s.call(a, S, k)),
                                    [i || 0, o, s]
                            }
                            function f(t, e) {
                                var i, n;
                            ...
                            function g() {
                                ...
                                if (o && n)
                                    ...
                                    b.init(c),
                                        ...
                                        b.CSS.setPropertyValue(c, "paddingLeft", r + "em"),
                                        l.percentToPxWidth = D.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(c, "width", null, !0)) || 1) / r,
                                        l.percentToPxHeight = D.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(c, "height", null, !0)) || 1) / r,
                                        l.emToPx = D.lastEmToPx = (parseFloat(x.getPropertyValue(c, "paddingLeft")) || 1) / r,
                                        t.myParent.removeChild(c)
                                }
                                return null === D.remToPx && (D.remToPx = parseFloat(x.getPropertyValue(i.body, "fontSize")) || 16),
                            ...
                            if ("scroll" === E) {
                                var C, P, T, M = /^x$/i.test(r.axis) ? "Left" : "Top", I = parseFloat(r.offset) || 0;
                                r.container ? m.isWrapped(r.container) || m.isNode(r.container) ? (r.container = r.container[0] || r.container,
                                    C = r.container["scroll" + M],
                                    T = C + d(a).position()[M.toLowerCase()] + I) : r.container = null : (C = b.State.scrollAnchor[b.State["scrollProperty" + M]],
                                    P = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === M ? "Top" : "Left")]],
                                    T = d(a).offset()[M.toLowerCase()] + I),
                                    l = {
                                        scroll: {
                                            rootPropertyValue: !1,
                                            startValue: C,
                                ...
                                if (!s(a).tweensContainer)
                                    return void d.dequeue(a, r.queue);
                                ...
                                for (var F in O)
                                    if ("element" !== F) {
                                        ...
                                        O[F].startValue = O[F].currentValue = O[F].endValue,
                                            O[F].endValue = L,
                                        m.isEmptyObject(y) || (O[F].easing = r.easing),
                                        b.debug && console.log("reverse tweensContainer (" + F + "): " + JSON.stringify(O[F]), a)
                                    }
                                l = O
                            } else if ("start" === E) {
                                var O;
                                s(a).tweensContainer && s(a).isAnimating === !0 && (O = s(a).tweensContainer),
                                ...
                                for (var z in v) {
                                    ...
                                    if (s(a).isSVG || "tween" === N || x.Names.prefixCheck(N)[1] !== !1 || x.Normalizations.registered[N] !== n) {
                                        (r.display !== n && null !== r.display && "none" !== r.display || r.visibility !== n && "hidden" !== r.visibility) && /opacity|filter/.test(z) && !H && 0 !== V && (H = 0),
                                            r._cacheValues && O && O[z] ? (H === n && (H = O[z].endValue + O[z].unitType),
                                                B = s(a).rootPropertyValueCache[N]) : x.Hooks.registered[z] ? H === n ? (B = x.getPropertyValue(a, N),
                                                H = x.getPropertyValue(a, z, B)) : B = x.Hooks.templates[N][1] : H === n && (H = x.getPropertyValue(a, z));
                                        var j, $, q, Y = !1;
                                        if (j = f(z, H),
                                                H = j[0],
                                                q = j[1],
                                                j = f(z, V),
                                                V = j[0].replace(/^([+-\/*])=/, function(t, e) {
                                                    return Y = e,
                                                        ""
                                                }),
                                                $ = j[1],
                                                H = parseFloat(H) || 0,
                                                V = parseFloat(V) || 0,
                                            "%" === $ && (/^(fontSize|lineHeight)$/.test(z) ? (V /= 100,
                                                $ = "em") : /^scale/.test(z) ? (V /= 100,
                                                $ = "") : /(Red|Green|Blue)$/i.test(z) && (V = V / 100 * 255,
                                                $ = "")),
                                                /[\/*]/.test(Y))
                                            $ = q;
                                        else if (q !== $ && 0 !== H)
                                        ...
                                        b.debug && console.log("tweensContainer (" + z + "): " + JSON.stringify(l[z]), a)
                                    } else
                            ...
                            l.element && (x.Values.addClass(a, "velocity-animating"),
                                R.push(l),
                            "" === r.queue && (s(a).tweensContainer = l,
                                s(a).opts = r),
                                s(a).isAnimating = !0,
                                S === k - 1 ? (b.State.calls.push([R, p, r, null, A.resolver]),
                                b.State.isTicking === !1 && (b.State.isTicking = !0,
                                    u())) : S++)
                        }
                        var o, a = this, r = d.extend({}, b.defaults, y), l = {};
                        switch (s(a) === n && b.init(a),
                        parseFloat(r.delay) && r.queue !== !1 && d.queue(a, r.queue, function(t) {
                        ...
                        b.mock !== !1 && (b.mock === !0 ? r.duration = r.delay = 1 : (r.duration *= parseFloat(b.mock) || 1,
                            r.delay *= parseFloat(b.mock) || 1)),
                            r.easing = c(r.easing, r.duration),
                        ...
                        r.display !== n && null !== r.display && (r.display = r.display.toString().toLowerCase(),
                        "auto" === r.display && (r.display = b.CSS.Values.getDisplayType(a))),
                        r.visibility !== n && null !== r.visibility && (r.visibility = r.visibility.toString().toLowerCase()),
                            r.mobileHA = r.mobileHA && b.State.isMobile && !b.State.isGingerbread,
                            r.queue === !1 ? r.delay ? setTimeout(t, r.delay) : t() : d.queue(a, r.queue, function(e, i) {
                    ...
                    if (m.isWrapped(this) ? (r = !1,
                            ...
                            p = a(p)) {
                        w ? (v = arguments[0].properties || arguments[0].p,
                            y = arguments[0].options || arguments[0].o) : (v = arguments[f],
                            y = arguments[f + 1]);
                        var k = p.length
                            , S = 0;
                                    ...
                                    e && d.each(e[1], function(i, o) {
                                        ...
                                        return a === !0 || e[2].queue === a || y === n && e[2].queue === !1 ? void d.each(p, function(i, n) {
                                            n === o && ((y === !0 || m.isString(y)) && (d.each(d.queue(n, m.isString(y) ? y : ""), function(t, e) {
                                                ...
                                                d.queue(n, m.isString(y) ? y : "", [])),
                                                "stop" === v ? (s(n) && s(n).tweensContainer && a !== !1 && d.each(s(n).tweensContainer, function(t, e) {
                                ...
                                if (!d.isPlainObject(v) || m.isEmptyObject(v)) {
                                    if (m.isString(v) && b.Redirects[v]) {
                                        var I = d.extend({}, y)
                                            , O = I.duration
                                            , F = I.delay || 0;
                                        return I.backwards === !0 && (p = d.extend(!0, [], p).reverse()),
                                            d.each(p, function(t, e) {
                                                parseFloat(I.stagger) ? I.delay = F + parseFloat(I.stagger) * t : m.isFunction(I.stagger) && (I.delay = F + I.stagger.call(e, t, k)),
                                                I.drag && (I.duration = parseFloat(O) || (/^(callout|transition)/.test(v) ? 1e3 : g),
                                                    I.duration = Math.max(I.duration * (I.backwards ? 1 - t / k : (t + 1) / k), .75 * I.duration, 200)),
                                                    b.Redirects[v].call(e, e, I || {}, t, k, p, A.promise ? A : n)
                                            }),
                                            t()
                                    }
    ...
    function() {
        ...
        var t = this
            ...
            , i = function(t) {
                ...
                return o = this.width = t.canvas.width,
        ...
        var n = i.helpers = {}
            ...
            , E = (n.calculateScaleRange = function(t, e, i, n, a) {
                    ...
                    h === u && (h += .5,
                        u >= .5 && !n ? u -= .5 : h += .5);
                    for (var d = Math.abs(h - u), f = T(d), p = Math.ceil(h / (1 * Math.pow(10, f))) * Math.pow(10, f), m = n ? 0 : Math.floor(u / (1 * Math.pow(10, f))) * Math.pow(10, f), v = p - m, g = Math.pow(10, f), w = Math.round(v / g); (w > r || r > 2 * w) && !l; )
                        if (w > r)
                            g *= 2,
                                w = Math.round(v / g),
                            w % 1 !== 0 && (l = !0);
                ...
                n.easingEffects = {
                    ...
                    easeInOutElastic: function(t) {
                        ...
                        return 0 === t ? 0 : 2 == (t /= .5) ? 1 : (i || (i = 1 * (.3 * 1.5)),
                            n < Math.abs(1) ? (n = 1,
                                e = i / 4) : e = i / (2 * Math.PI) * Math.asin(1 / n),
                            1 > t ? -.5 * (n * Math.pow(2, 10 * (t -= 1)) * Math.sin((1 * t - e) * (2 * Math.PI) / i)) : n * Math.pow(2, -10 * (t -= 1)) * Math.sin((1 * t - e) * (2 * Math.PI) / i) * .5 + 1)
                    },
            ...
            , R = (n.cancelAnimFrame = function() {
                    ...
                    n.animationLoop = function(t, e, i, n, o, a) {
                        var s = 0
                            ...
                            , l = function() {
                                ...
                                t.call(a, c, i, s),
                                    n.call(a, c, i),
                                    e > s ? a.animationFrame = O(l) : o.apply(a)
                            };
                        O(l)
                    }
                    ,
                    n.getRelativePosition = function(t) {
                        ...
                        return n.touches ? (e = n.touches[0].clientX - a.left,
                            i = n.touches[0].clientY - a.top) : (e = n.clientX - a.left,
                            i = n.clientY - a.top),
                        {
                            x: e,
                            y: i
            ...
            , j = (n.getMaximumSize = n.getMaximumWidth,
            ...
            , X = n.drawRoundedRectangle = function(t, e, i, n, o, a) {
                t.beginPath(),
                    t.moveTo(e + a, i),
                    t.lineTo(e + n - a, i),
        ...
        i.instances = {},
                    ...
                    if (a || e) {
                        if (this.activeElements = t,
                            ...
                            if (this.datasets && this.datasets.length > 1) {
                                for (var s, r, c = this.datasets.length - 1; c >= 0 && (s = this.datasets[c].points || this.datasets[c].bars || this.datasets[c].segments,
                                    r = l(s, t[0]),
                                -1 === r); c--)
                                    ;
                                var u = []
            ...
            i.Tooltip = i.Element.extend({
                draw: function() {
                    ...
                    t.font = q(this.fontSize, this.fontStyle, this.fontFamily),
                        this.xAlign = "center",
                        this.yAlign = "above";
                    ...
                    if (t.fillStyle = this.fillColor,
                        ...
                        X(t, a, s, i, n, this.cornerRadius),
                            t.fill(),
                            t.fillStyle = this.textColor,
                            t.textAlign = "center",
                            t.textBaseline = "middle",
                            t.fillText(this.text, a + i / 2, s + n / 2)
                    }
                }
            }),
            i.MultiTooltip = i.Element.extend({
                initialize: function() {
                    this.font = q(this.fontSize, this.fontStyle, this.fontFamily),
                        this.titleFont = q(this.titleFontSize, this.titleFontStyle, this.titleFontFamily),
                ...
                draw: function() {
                    if (this.custom)
                        ...
                        X(this.ctx, this.x, this.y - this.height / 2, this.width, this.height, this.cornerRadius);
                        var t = this.ctx;
                        t.fillStyle = this.fillColor,
                            t.fill(),
                            t.closePath(),
                            ...
                            t.font = this.font,
                            n.each(this.labels, function(e, i) {
                                t.fillStyle = this.textColor,
            ...
            i.Scale = i.Element.extend({
                ...
                fit: function() {
                    ...
                    for (this.calculateYRange(e),
                        ...
                        e = this.endPoint - this.startPoint,
                            ...
                            this.buildYLabels(),
                        i < this.yLabelWidth && (this.endPoint = t,
                ...
                calculateXLabelRotation: function() {
                    ...
                    if (this.xScalePaddingRight = e / 2 + 3,
                            this.xScalePaddingLeft = t / 2 > this.yLabelWidth ? t / 2 : this.yLabelWidth,
                ...
                calculateX: function(t) {
                    ...
                    return this.offsetGridLines && (o += n / 2),
                        Math.round(o)
                },
                update: function(t) {
                    n.extend(this, t),
                ...
                draw: function() {
                    ...
                    this.display && (t.fillStyle = this.textColor,
                        ...
                        o(this.yLabels, function(o, a) {
                            ...
                            t.textAlign = "right",
                                t.textBaseline = "middle",
                            this.showLabels && t.fillText(o, i - 10, s),
                            0 !== a || l || (l = !0),
                            l && t.beginPath(),
                                a > 0 ? (t.lineWidth = this.gridLineWidth,
                        ...
                        o(this.xLabels, function(e, i) {
                            ...
                            s && (t.moveTo(o, this.endPoint),
                                ...
                                t.rotate(-1 * C(this.xLabelRotation)),
                                t.font = this.font,
            ...
            i.RadialScale = i.Element.extend({
                ...
                setScaleSize: function() {
                    var e, i, n, o, s, r, c, u, h, d, f, p, t = b([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]), a = this.width, l = 0;
                    for (this.ctx.font = q(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily),
                             i = 0; i < this.valuesCount; i++)
                        e = this.getPointPosition(i, t),
                            n = this.ctx.measureText(E(this.templateString, {
                                    value: this.labels[i]
                                })).width + 5,
                            0 === i || i === this.valuesCount / 2 ? (o = n / 2,
                            e.x + o > a && (a = e.x + o,
                                s = i),
                            e.x - o < l && (l = e.x - o,
                                c = i)) : i < this.valuesCount / 2 ? e.x + n > a && (a = e.x + n,
                                s = i) : i > this.valuesCount / 2 && e.x - n < l && (l = e.x - n,
                                c = i);
                    h = l,
                        d = Math.ceil(a - this.width),
                        r = this.getIndexAngle(s),
                        u = this.getIndexAngle(c),
                        f = d / Math.sin(r + Math.PI / 2),
                        p = h / Math.sin(u + Math.PI / 2),
                        f = g(f) ? f : 0,
                        p = g(p) ? p : 0,
                        this.drawingArea = t - (p + f) / 2,
                        this.setCenterPoint(p, f)
                },
                ...
                draw: function() {
                    if (this.display) {
                        ...
                        if (o(this.yLabels, function(e, i) {
                                if (i > 0) {
                                    var a, n = i * (this.drawingArea / this.steps), o = this.yCenter - n;
                                    if (this.lineWidth > 0)
                                        if (t.strokeStyle = this.lineColor,
                                            ...
                                            for (var s = 0; s < this.valuesCount; s++)
                                                a = this.getPointPosition(s, this.calculateCenterOffset(this.min + i * this.stepValue)),
                                                    0 === s ? t.moveTo(a.x, a.y) : t.lineTo(a.x, a.y);
                                            t.closePath(),
                                                t.stroke()
                                        }
                                    if (this.showLabels) {
                                        if (t.font = q(this.fontSize, this.fontStyle, this.fontFamily),
                            ...
                            for (var e = this.valuesCount - 1; e >= 0; e--) {
                                ...
                                t.font = q(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily),
                                ...
                                var u = this.labels.length
                                    ...
                                    , f = d > e || e > u - d
                                    , p = e === d || e === u - d;
                                0 === e ? t.textAlign = "center" : e === h ? t.textAlign = "center" : h > e ? t.textAlign = "left" : t.textAlign = "right",
                                    p ? t.textBaseline = "middle" : f ? t.textBaseline = "bottom" : t.textBaseline = "top",
                                    t.fillText(this.labels[e], c.x, c.y)
                            }
                        }
                    }
                }
            ...
            i.animationService = {
                ...
                startDigest: function() {
                    var t = Date.now()
                        , e = 0;
                    this.dropFrames > 1 && (e = Math.floor(this.dropFrames),
                        this.dropFrames -= e);
                    for (var i = 0; i < this.animations.length; i++)
            ...
            getBarsAtEvent: function(t) {
                for (var a, e = [], n = i.getRelativePosition(t), o = function(t) {
                    ...
                    for (a = 0; a < this.datasets[s].bars.length; a++)
                        if (this.datasets[s].bars[a].inRange(n.x, n.y))
    ...
    function() {
        ...
        e.Type.extend({
            ...
            initialize: function(t) {
                ...
                this.options.showTooltips && i.bindEvents(this, this.options.tooltipEvents, function(t) {
                    ...
                    i.each(t, function(e, i) {
                        e.color || (e.color = "hsl(" + 360 * i / t.length + ", 100%, 50%)"),
                            this.addData(e, i, !0)
                    }, this),
                    this.render()
            },
            ...
            addData: function(t, i, n) {
                ...
                "undefined" == typeof t.color && (t.color = e.defaults.global.segmentColorDefault[o % e.defaults.global.segmentColorDefault.length],
                    t.highlight = e.defaults.global.segmentHighlightColorDefaults[o % e.defaults.global.segmentHighlightColorDefaults.length]),
                ...
                this.scale && (this.scale.draw(e),
                    i.each(this.datasets, function(t) {
                        ...
                        this.options.bezierCurve && i.each(r, function(t, e) {
                            ...
                            t.controlPoints = i.splineCurve(s(t, r, e), t, a(t, r, e), n),
                        ...
                        this.options.datasetFill && r.length > 0 && (n.lineTo(r[r.length - 1].x, this.scale.endPoint),
    ...
    function() {
        ...
        e.Type.extend({
                ...
                this.options.showTooltips && i.bindEvents(this, this.options.tooltipEvents, function(t) {
                    ...
                    i.each(t.datasets, function(e) {
                        ...
                        this.datasets.push(n),
                            i.each(e.data, function(i, o) {
                                var a;
                                this.scale.animation || (a = this.scale.getPointPosition(o, this.scale.calculateCenterOffset(i))),
                                    n.points.push(new this.PointClass({
                                        value: i,
                                        label: t.labels[o],
                                        datasetLabel: e.label,
            ...
            getPointsAtEvent: function(t) {
                ...
                n.distance <= this.scale.drawingArea && i.each(this.datasets, function(t) {
                    s.push(t.points[a])
                }),
                    s
            },
                ...
                t.prototype.createEvent = function(t, e, i, n) {
                    ...
                    null == n && (n = null),
                        null != document.createEvent ? (o = document.createEvent("CustomEvent"),
                            o.initCustomEvent(t, e, i, n)) : null != document.createEventObject ? (o = document.createEventObject(),
                            ...
                            o = e[i],
                                ...
                                n.push(function() {
                                    ...
                                    for (s = this.vendors,
                                             ...
                                             n = s.length; n > e; e++)
                                        a = s[e],
                                            r.push(t["" + a + i.charAt(0).toUpperCase() + i.substr(1)] = o);
                                    return r
                                }
                                    .call(this));
                        return n
    ...
    function(t, e) {
        ...
        function v(t) {
            ...
            if (null !== e) {
                ...
                if (p.registerEvent(t),
                    ...
                    h.show(t, e),
                    n && (e.addEventListener("touchend", h.hide, !1),
                        e.addEventListener("touchcancel", h.hide, !1)),
                        e.addEventListener("mouseup", h.hide, !1),
                        e.addEventListener("mouseleave", h.hide, !1)
            }
        }
        var t = t || {}
            ...
            , h = {
                ...
                show: function(t, e, i) {
                    ...
                    "touches"in t && t.touches.length ? (a = t.touches[0].pageY - o.top,
                        s = t.touches[0].pageX - o.left) : (a = t.pageY - o.top,
                        s = t.pageX - o.left),
                        s = s >= 0 ? s : 0,
                        a = a >= 0 ? a : 0;
                ...
                hide: function(t, e) {
                    e = e || this;
                    for (var i = e.getElementsByClassName("waves-rippling"), n = 0, o = i.length; o > n; n++)
                        f(t, e, i[n])
                }
            }
            , d = {
            ...
            , p = {
                ...
                allowEvent: function(t) {
                    var e = !0;
                    return /^(mousedown|mousemove)$/.test(t.type) && p.touches && (e = !1),
                        e
                },
        ...
        return t.init = function(t) {
            var e = document.body;
            t = t || {},
            "duration"in t && (h.duration = t.duration),
            "delay"in t && (h.delay = t.delay),
            n && (e.addEventListener("touchstart", v, !1),
    ...
    $(document).ready(function() {
        $("#preloader-markup").load("mdb-addons/preloader.html", function() {
            $("#mdb-preloader").delay(2500).fadeOut("slow")
        })
    }),
    function(t) {
        ...
        t(["jquery"], function(t) {
            return function() {
                ...
                function p(i) {
                    var n = x();
                    return e || l(n),
                        i && 0 === t(":focus", i).length ? void C(i) : void (e.children().length && e.remove())
                }
                function m(i) {
                ...
                function g(i) {
                    return e = t("<div/>").attr("id", i.containerId).addClass(i.positionClass).attr("aria-live", "polite").attr("role", "alert"),
                        e.appendTo(t(i.target)),
                        e
                }
                function y() {
                    return {
                ...
                function w(i) {
                    function v(t) {
                        return null == t && (t = ""),
                            new String(t).replace(/&/g, "&amp;").replace(/"/g, "&quot;").replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;")
                    }
                    function g() {
                        k(),
                            P(),
                    ...
                    function y() {
                        c.hover(F, O),
                        !o.onclick && o.tapToDismiss && c.click(I),
                        o.closeButton && f && f.click(function(t) {
                    ...
                    function w() {
                        ...
                        o.timeOut > 0 && (r = setTimeout(I, o.timeOut),
                            p.maxHideTime = parseFloat(o.timeOut),
                            p.hideEta = (new Date).getTime() + p.maxHideTime,
                        o.progressBar && (p.intervalId = setInterval(L, 10)))
                    }
                    function k() {
                    ...
                    function P() {
                        i.title && (u.append(o.escapeHtml ? v(i.title) : i.title).addClass(o.titleClass),
                            c.append(u))
                    }
                    function T() {
                        i.message && (h.append(o.escapeHtml ? v(i.message) : i.message).addClass(o.messageClass),
                            c.append(h))
                    }
                    function A() {
                        o.closeButton && (f.addClass("toast-close-button").attr("role", "button"),
                            c.prepend(f))
                    }
                    function E() {
                        o.progressBar && (d.addClass("toast-progress"),
                            c.prepend(d))
                    }
                    function M(t, e) {
                    ...
                    function I(e) {
                        ...
                        return !t(":focus", c).length || e ? (clearTimeout(p.intervalId),
                            c[i]({
                                duration: n,
                                easing: a,
                                complete: function() {
                                    C(c),
                                    o.onHidden && "hidden" !== m.state && o.onHidden(),
                                        m.state = "hidden",
                                        m.endTime = new Date,
                                        b(m)
                                }
                    ...
                    function O() {
                        (o.timeOut > 0 || o.extendedTimeOut > 0) && (r = setTimeout(I, o.extendedTimeOut),
                            p.maxHideTime = parseFloat(o.extendedTimeOut),
                            p.hideEta = (new Date).getTime() + p.maxHideTime)
                    }
                    function F() {
                        clearTimeout(r),
                            p.hideEta = 0,
                            c.stop(!0, !0)[o.showMethod]({
                                duration: o.showDuration,
                                easing: o.showEasing
                            })
                    }
                    ...
                    if ("undefined" != typeof i.optionsOverride && (o = t.extend(o, i.optionsOverride),
            ...
            t.fn.dropdown = function(e) {
                ...
                this.each(function() {
                    ...
                    function r() {
                        s(),
                            a.addClass("active"),
                        o.constrain_width === !0 && a.css("width", n.outerWidth());
                        var e = 0;
                        o.belowOrigin === !0 && (e = n.height());
                        var i = n.offset().left
                            , r = 0
                            , l = o.gutter;
                        i + a.innerWidth() > t(window).width() && (r = n.innerWidth() - a.innerWidth(),
                            l = -1 * l),
                            a.css({
                                position: "absolute",
                    ...
                    if (s(),
                        ...
                        n.unbind("click." + n.attr("id")),
                            ...
                            a.on("mouseleave", function(e) {
                                var i = e.toElement || e.relatedTarget;
                                t(i).closest(".dropdown-button").is(n) || (a.stop(!0, !0),
                                    l(),
                                    c = !1)
                            })
                    } else
                        n.unbind("click." + n.attr("id")),
                            n.bind("click." + n.attr("id"), function(e) {
                                n[0] == e.currentTarget && 0 === t(e.target).closest(".dropdown-content").length ? (e.preventDefault(),
                                    r()) : n.hasClass("active") && (l(),
                                    t(document).unbind("click." + a.attr("id"))),
                                a.hasClass("active") && t(document).bind("click." + a.attr("id"), function(e) {
                                    !a.is(e.target) && !n.is(e.target) && !n.find(e.target).length > 0 && (l(),
                                        t(document).unbind("click." + a.attr("id")))
                                })
                            });
                    n.on("open", r),
        ...
        t.fn.extend({
            openModal: function(i) {
                ...
                var o = {
                    ...
                    , l = ++e;
                r.attr("id", a).css("z-index", 1e3 + 2 * l),
                    s.data("overlay-id", a).css("z-index", 1e3 + 2 * l + 1),
                    t("body").append(r),
                    i = t.extend(o, i),
                i.dismissible && (r.click(function() {
                    s.closeModal(i)
                }),
            ...
            t.fn.extend({
                closeModal: function(i) {
                    ...
                    i = t.extend(n, i),
                        ...
                        t(document).off("keyup.leanModal" + a),
                        s.velocity({
                            opacity: 0
                        }, {
    ...
    function(t, e, i, n) {
        ...
        function h(t, e, i) {
            return Array.isArray(t) ? (d(t, i[e], i),
                !0) : !1
        }
        function d(t, e, i) {
            var o;
        ...
        function at(t, e) {
            var i = t.session
                , n = e.pointers
                , o = n.length;
            i.firstInput || (i.firstInput = lt(e)),
                o > 1 && !i.firstMultiple ? i.firstMultiple = lt(e) : 1 === o && (i.firstMultiple = !1);
            var a = i.firstInput
                , s = i.firstMultiple
            ...
            e.timeStamp = c(),
                ...
                e.distance = dt(r, u),
                st(i, e),
                e.offsetDirection = ht(e.deltaX, e.deltaY);
            var h = ut(e.deltaTime, e.deltaX, e.deltaY);
            e.overallVelocityX = h.x,
                e.overallVelocityY = h.y,
                e.overallVelocity = l(h.x) > l(h.y) ? h.x : h.y,
                e.scale = s ? mt(s.pointers, n) : 1,
                e.rotation = s ? pt(s.pointers, n) : 0,
        ...
        function st(t, e) {
            var i = e.center
                ...
                , o = t.prevDelta || {}
                , a = t.prevInput || {};
            (e.eventType === B || a.eventType === $) && (o = t.prevDelta = {
                x: a.deltaX || 0,
                y: a.deltaY || 0
            },
                n = t.offsetDelta = {
        ...
        function rt(t, e) {
            var a, s, r, c, i = t.lastInterval || e, o = e.timeStamp - i.timeStamp;
        ...
        function Mt(t, e) {
            ...
            return e & ($ | q) && (i = E(i.concat(n), "identifier", !0)),
                [i, n]
        }
        function Ft() {
            this.evTarget = Ot,
        ...
        function Lt(t, e) {
            ...
            if (e & (B | j) && 1 === i.length)
                return n[i[0].identifier] = !0,
                    [i, i];
            var o, a, s = A(t.changedTouches), r = [], l = this.target;
            if (a = i.filter(function(t) {
                ...
                for (o = 0; o < a.length; )
                    n[a[o].identifier] = !0,
                        o++;
            for (o = 0; o < s.length; )
                n[s[o].identifier] && r.push(s[o]),
                e & ($ | q) && delete n[s[o].identifier],
                    o++;
        ...
        function zt() {
            ...
            this.touch = new Ft(this.manager,t),
                this.mouse = new bt(this.manager,t),
                this.primaryTouch = null,
                this.lastTouches = []
        }
        function _t(t, e) {
            t & B ? (this.primaryTouch = e.changedPointers[0].identifier,
                Vt.call(this, e)) : t & ($ | q) && Vt.call(this, e)
        }
        function Vt(t) {
        ...
        function ve(t, e) {
            return e = e || {},
                e.recognizers = w(e.recognizers, ve.defaults.preset),
                new be(t,e)
        }
        function be(t, e) {
            this.options = p({}, ve.defaults, e || {}),
                ...
                d(t.options.cssProps, function(o, a) {
                    n = M(i.style, a),
                        e ? (t.oldCssProps[n] = i.style[n],
                            i.style[n] = o) : i.style[n] = t.oldCssProps[n] || ""
                }),
                e || (t.oldCssProps = {})
            }
        }
        ...
        var p, o = ["", "webkit", "Moz", "MS", "ms", "o"], a = e.createElement("div"), s = "function", r = Math.round, l = Math.abs, c = Date.now;
        ...
        it.prototype = {
            ...
            destroy: function() {
                ...
                this.evWin && C(F(this.element), this.evWin, this.domHandler)
            }
        };
        var vt = {
                mousedown: B,
        ...
        t.MSPointerEvent && !t.PointerEvent && (Ct = "MSPointerDown",
            ...
            g(St, it, {
                handler: function(t) {
                    ...
                    o & B && (0 === t.button || s) ? 0 > r && (e.push(t),
                        r = e.length - 1) : o & ($ | q) && (i = !0),
                    0 > r || (e[r] = t,
        ...
        g(Et, it, {
            handler: function(t) {
                var e = Pt[t.type];
                if (e === B && (this.started = !0),
                        this.started) {
                    var i = Mt.call(this, t, e);
                    e & ($ | q) && i[0].length - i[1].length === 0 && (this.started = !1),
                        this.callback(this.manager, e, {
                            pointers: i[0],
                            changedPointers: i[1],
                            pointerType: _,
        ...
        Zt.prototype = {
            set: function(t) {
                t == Bt && (t = this.compute()),
                Nt && this.manager.element.style && Qt[t] && (this.manager.element.style[Ht] = t),
            ...
            preventDefaults: function(t) {
                ...
                return s && a ? void 0 : o || a && i & U || s && i & K ? this.preventSrc(e) : void 0
            },
        ...
        ae.prototype = {
            ...
            dropRecognizeWith: function(t) {
                return h(t, "dropRecognizeWith", this) ? this : (t = le(t, this),
            ...
            emit: function(t) {
                ...
                var e = this
                    , i = this.state;
                ee > i && n(e.options.event + se(i)),
                    n(e.options.event),
                t.additionalEvent && n(t.additionalEvent),
                i >= ee && n(e.options.event + se(i))
            },
            tryEmit: function(t) {
            ...
            canEmit: function() {
                for (var t = 0; t < this.requireFail.length; ) {
                    if (!(this.requireFail[t].state & (oe | Kt)))
                        return !1;
                    t++
                }
                return !0
            ...
            recognize: function(t) {
                var e = p({}, t);
                return b(this.options.enable, [this, e]) ? (this.state & (ie | ne | oe) && (this.state = Kt),
                    this.state = this.process(e),
                    void (this.state & (Jt | te | ee | ne) && this.tryEmit(e))) : (this.reset(),
                    void (this.state = oe))
            },
            process: function(t) {},
            ...
            g(ce, ae, {
                ...
                process: function(t) {
                    var e = this.state
                        ...
                        , n = e & (Jt | te)
                        , o = this.attrTest(t);
                    return n && (i & q || !o) ? e | ne : n || o ? i & $ ? e | ee : e & Jt ? e | te : Jt : oe
                }
            }),
            g(ue, ce, {
                defaults: {
                ...
                directionTest: function(t) {
                    var e = this.options
                        ...
                        , a = t.deltaX
                        , s = t.deltaY;
                    return o & e.direction || (e.direction & U ? (o = 0 === a ? Y : 0 > a ? X : Q,
                        i = a != this.pX,
                        n = Math.abs(t.deltaX)) : (o = 0 === s ? Y : 0 > s ? Z : G,
                        i = s != this.pY,
                        n = Math.abs(t.deltaY))),
                        t.direction = o,
            ...
            g(de, ae, {
                ...
                emit: function(t) {
                    this.state === ie && (t && t.eventType & $ ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = c(),
            ...
            g(pe, ce, {
                ...
                attrTest: function(t) {
                    ...
                    return e & (U | K) ? i = t.overallVelocity : e & U ? i = t.overallVelocityX : e & K && (i = t.overallVelocityY),
                    this._super.attrTest.call(this, t) && e & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && l(i) > this.options.velocity && t.eventType & $
                },
                emit: function(t) {
            ...
            g(me, ae, {
                ...
                emit: function() {
                    this.state == ie && (this._input.tapCount = this.count,
                        this.manager.emit(this.options.event, this._input))
                }
            }),
            ve.VERSION = "2.0.7",
            ...
            recognize: function(t) {
                ...
                if (!e.stopped) {
                    ...
                    for (var a = 0; a < n.length; )
                        i = n[a],
                            e.stopped === ye || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(t),
                        !o && i.state & (Jt | te | ee) && (o = e.curRecognizer = i),
                            a++
                }
            },
            get: function(t) {
            ...
            init: function(e) {
                ...
                e = t.extend(i, e),
                    t(this).each(function() {
                        ...
                        t("body").append(o),
                            "left" == e.edge ? (n.css("left", -1 * (e.menuWidth + 10)),
                                o.css({
                                    left: 0
                                })) : (n.addClass("right-aligned").css("right", -1 * (e.menuWidth + 10)).css("left", ""),
                                o.css({
                                    right: 0
                                })),
                        n.hasClass("fixed") && window.innerWidth > 992 && n.css("left", 0),
                        n.hasClass("fixed") && t(window).resize(function() {
                            window.innerWidth > 992 ? 0 !== t("#sidenav-overlay").css("opacity") && r ? a(!0) : (n.removeAttr("style"),
                                n.css("width", e.menuWidth)) : r === !1 && ("left" === e.edge ? n.css("left", -1 * (e.menuWidth + 10)) : n.css("right", -1 * (e.menuWidth + 10)))
                        }),
                        ...
                        o.on("click", function() {
                            ...
                            o.hammer({
                                ...
                                if ("touch" == i.gesture.pointerType) {
                                    ...
                                    if ("left" === e.edge && (s > e.menuWidth ? s = e.menuWidth : 0 > s && (s = 0)),
                                        "left" === e.edge)
                                        s < e.menuWidth / 2 ? r = !1 : s >= e.menuWidth / 2 && (r = !0),
                                            n.css("left", s - e.menuWidth);
                                    else {
                                    ...
                                    "left" === e.edge ? (d = s / e.menuWidth,
                                        t("#sidenav-overlay").velocity({
                                            ...
                                            queue: !1,
                                            easing: "easeOutQuad"
                                        })) : (d = Math.abs((s - window.innerWidth) / e.menuWidth),
                                        t("#sidenav-overlay").velocity({
                                            opacity: d
                                        }, {
                                            duration: 50,
                                ...
                                if ("touch" == i.gesture.pointerType) {
                                    ...
                                    s = !1,
                                        "left" === e.edge ? r && .3 >= a || -.5 > a ? (n.velocity({
                                            left: 0
                                        }, {
                                            duration: 300,
                                            queue: !1,
            ...
            return e = t.extend(i, e),
                this.each(function() {
                    ...
                    i.off("click.collapse", ".collapsible-header"),
                        ...
                        e.accordion || "accordion" === o || void 0 === o ? (n = i.find("> li > .collapsible-header"),
    ...
    function(t, e) {
        ...
        var e = function(t, e) {
                ...
                var r = function(t, e, i) {
                    ...
                    , u = function() {
                        e.scaleColor && l(),
                        e.trackColor && r(e.trackColor, e.trackWidth || e.lineWidth, 1)
                    };
                this.getCanvas = function() {
                    ...
                    this.animate = function(t, i) {
                        ...
                        var o = function() {
                            ...
                            this.draw(s),
                                e.onStep(t, i, s),
                                a >= e.animate.duration ? e.onStop(t, i) : c(o)
                        }
                            .bind(this);
                        c(o)
                    }
                ...
                t(this).each(function() {
                    ...
                    if (!n.hasClass("browser-default")) {
                        ...
                        var l = t('<ul id="select-options-' + s + '" class="dropdown-content select-dropdown ' + (o ? "multiple-select-dropdown" : "") + '"></ul>')
                            ...
                            , f = function(e, i, n) {
                                ...
                                if (a) {
                                    var r = "";
                                    return s && (r = ' class="' + s + '"'),
                                        "multiple" === n ? l.append(t('<li class="' + o + '"><img src="' + a + '"' + r + '><span><input type="checkbox"' + o + "/><label></label>" + i.html() + "</span></li>")) : l.append(t('<li class="' + o + '"><img src="' + a + '"' + r + "><span>" + i.html() + "</span></li>")),
                                        !0
                                }
                        ...
                        c.length && c.each(function() {
                            if (t(this).is("option"))
                                o ? f(n, t(this), "multiple") : f(n, t(this));
                                ...
                                t(this).click(function(s) {
                                    if (!t(this).hasClass("disabled") && !t(this).hasClass("optgroup")) {
                                        ...
                                        o ? (t('input[type="checkbox"]', this).prop("checked", function(t, e) {
                                            ...
                                            r = i(u, t(this).index(), n),
                                            v.trigger("focus")) : (l.find("li").removeClass("active"),
                                            t(this).toggleClass("active"),
                                            v.val(t(this).text())),
                                            activateOption(l, t(this)),
                                            n.find("option").eq(a).prop("selected", r),
                                            n.trigger("change"),
                        ...
                        n.before(v),
                            v.before(p),
                            v.after(l),
                        n.is(":disabled") || v.dropdown({
                            hover: !1,
                            closeOnClick: !1
                        }),
                        n.attr("tabindex") && t(v[0]).attr("tabindex", n.attr("tabindex")),
                        ...
                        var g = []
                            , y = function(e) {
                                ...
                                if (13 != e.which || l.is(":visible")) {
                                    ...
                                    40 == e.which && (s = l.find("li.selected").length ? l.find("li.selected").next("li:not(.disabled)")[0] : l.find("li:not(.disabled)")[0],
                                        activateOption(l, s)),
                                    27 == e.which && v.trigger("close"),
                                    38 == e.which && (s = l.find("li.selected").prev("li:not(.disabled)")[0],
                                    s && activateOption(l, s)),
                                        setTimeout(function() {
                                            g = []
                                        }, 1e3)
    ...
    function(t) {
        ...
        function a(e, c, u, d) {
            ...
            function x() {
                g.data(c, b).addClass(v.input).val(g.data("value") ? b.get("select", m.format) : e.value),
                m.editable || g.on("focus." + p.id + " click." + p.id, function(t) {
                    t.preventDefault(),
                        b.open()
                }).on("keydown." + p.id, A),
                    l(e, {
            ...
            function k() {
                b.$holder.on({
                    ...
                    focusin: function(t) {
                        b.$root.removeClass(v.focused),
                            t.stopPropagation()
                    },
                    "mousedown click": function(e) {
                        var i = e.target;
                        i != b.$holder[0] && (e.stopPropagation(),
                    ...
                    var e = t(this)
                        ...
                        , o = h();
                    o = o && (o.type || o.href),
                    (n || o && !t.contains(b.$root[0], o)) && b.$holder[0].focus(),
                        !n && i.nav ? b.set("highlight", b.component.item.highlight, {
                            nav: i.nav
                        }) : !n && "pick"in i ? (b.set("select", i.pick),
                        m.closeOnSelect && b.close(!0)) : i.clear ? (b.clear(),
                        m.closeOnClear && b.close(!0)) : i.close && b.close(!0)
                })
            }
            function S() {
                var i;
                m.hiddenName === !0 ? (i = e.name,
                    e.name = "") : (i = ["string" == typeof m.hiddenPrefix ? m.hiddenPrefix : "", "string" == typeof m.hiddenSuffix ? m.hiddenSuffix : "_submit"],
                    i = i[0] + e.name + i[1]),
                    b._hidden = t('<input type=hidden name="' + i + '"' + (g.data("value") || e.value ? ' value="' + b.get("select", m.formatSubmit) + '"' : "") + ">")[0],
                    g.on("change." + p.id, function() {
                        b._hidden.value = e.value ? b.get("select", m.formatSubmit) : ""
                    })
            }
            function P() {
                f && o ? b.$holder.find("." + v.frame).one("transitionend", function() {
                    b.$holder[0].focus()
                }) : b.$holder[0].focus()
            }
            function T(t) {
                t.stopPropagation(),
                    g.addClass(v.target),
                    b.$root.addClass(v.focused),
                    b.open()
            }
            function A(t) {
                var e = t.keyCode
                    , i = /^(8|46)$/.test(e);
                return 27 == e ? (b.close(!0),
                    !1) : void ((32 == e || i || !p.open && b.component.key[e]) && (t.preventDefault(),
                    t.stopPropagation(),
                ...
                , b = y.prototype = {
                    ...
                    start: function() {
                        return p && p.start ? b : (p.methods = {},
                            ...
                            p.type = e.type,
                            e.autofocus = e == h(),
                            e.readOnly = !m.editable,
                            e.id = e.id || p.id,
                        "text" != e.type && (e.type = "text"),
                            b.component = new u(b,m),
                        ...
                        m.formatSubmit && S(),
                            x(),
                            m.containerHidden ? t(m.containerHidden).append(b._hidden) : g.after(b._hidden),
                            m.container ? t(m.container).append(b.$root) : g.after(b.$root),
                            b.on({
                    ...
                    render: function(e) {
                        return e ? (b.$holder = t(w()),
                            k(),
                            b.$root.html(b.$holder)) : b.$root.find("." + v.box).html(b.component.nodes(p.open)),
                            b.trigger("render")
                    },
                    stop: function() {
                        ...
                        b._hidden && b._hidden.parentNode.removeChild(b._hidden),
                            b.$root.remove(),
                            g.removeClass(v.input).removeData(c),
                            setTimeout(function() {
                                g.off("." + p.id)
                            }, 0),
                            e.type = p.type,
                    ...
                    open: function(o) {
                        return p.open ? b : (g.addClass(v.active),
                            l(e, "expanded", !0),
                            setTimeout(function() {
                                b.$root.addClass(v.opened),
                                    l(b.$root[0], "hidden", !1)
                            }, 0),
                        o !== !1 && (p.open = !0,
                        f && n.css("overflow", "hidden").css("padding-right", "+=" + r()),
                            P(),
                            i.on("click." + p.id + " focusin." + p.id, function(t) {
                                ...
                                var i = e.keyCode
                                    , n = b.component.key[i]
                                    , o = e.target;
                                27 == i ? b.close(!0) : o != b.$holder[0] || !n && 13 != i ? t.contains(b.$root[0], o) && 13 == i && (e.preventDefault(),
                                    o.click()) : (e.preventDefault(),
                                    n ? a._.trigger(b.component.key.go, b, [a._.trigger(n)]) : b.$root.find("." + v.highlighted).hasClass(v.disabled) || (b.set("select", b.component.item.highlight),
                                    m.closeOnSelect && b.close(!0)))
                            })),
                            b.trigger("open"))
                    },
                    close: function(t) {
                        return t && (m.editable ? e.focus() : (b.$holder.off("focus.toOpen").focus(),
                            setTimeout(function() {
                            ...
                            l(e, "expanded", !1),
                            setTimeout(function() {
                                b.$root.removeClass(v.opened + " " + v.focused),
                                    l(b.$root[0], "hidden", !0)
                            }, 0),
                            p.open ? (p.open = !1,
                            f && n.css("overflow", "").css("padding-right", "-=" + r()),
                                i.off("." + p.id),
                                b.trigger("close")) : b
                    },
                    clear: function(t) {
                    ...
                    set: function(e, i, n) {
                        var o, a, s = t.isPlainObject(e), r = s ? e : {};
                        if (n = s && t.isPlainObject(i) ? i : n || {},
                                e) {
                            s || (r[e] = i);
                            for (o in r)
                                a = r[o],
                                o in b.component.item && (void 0 === a && (a = null),
                                    b.component.set(o, a, n)),
                                ("select" == o || "clear" == o) && g.val("clear" == o ? "" : b.get(o, m.format)).trigger("change");
                            b.render()
                        }
                    ...
                    off: function() {
                        ...
                        for (t = 0,
                            ...
                            e = i[t],
                            e in p.methods && delete p.methods[e];
                        return b
                    },
        ...
        a.prototype.set = function(t, e, i) {
            ...
            a.prototype.create = function(t, i, n) {
                ...
                return i = void 0 === i ? t : i,
                    i == -(1 / 0) || i == 1 / 0 ? a = i : e.isPlainObject(i) && o.isInteger(i.pick) ? i = i.obj : e.isArray(i) ? (i = new Date(i[0],i[1],i[2]),
                        i = o.isDate(i) ? i : s.create().obj) : i = o.isInteger(i) || o.isDate(i) ? s.normalize(new Date(i), n) : s.now(t, i, n),
                {
            ...
            a.prototype.createRange = function(t, i) {
                ...
                return o.isInteger(t) || (t = a(t)),
                o.isInteger(i) || (i = a(i)),
                    o.isInteger(t) && e.isPlainObject(i) ? t = [i.year, i.month, i.date + t] : o.isInteger(i) && e.isPlainObject(t) && (i = [t.year, t.month, t.date + i]),
                {
                    from: a(t),
                    to: a(i)
                }
            ...
            a.prototype.navigate = function(t, i, n) {
                var o, a, s, r, l = e.isArray(i), c = e.isPlainObject(i), u = this.item.view;
                if (l || c) {
                    for (c ? (a = i.year,
                        s = i.month,
                        r = i.date) : (a = +i[0],
                        s = +i[1],
                        r = +i[2]),
                         n && n.nav && u && u.month !== s && (a = u.year,
                             s = u.month),
                             o = new Date(a,s + (n && n.nav ? n.nav : 0),1),
                             a = o.getFullYear(),
                             s = o.getMonth(); new Date(a,s,r).getMonth() !== s; )
                        r -= 1;
                    i = [a, s, r]
                }
                return i
            ...
            a.prototype.validate = function(t, i, n) {
                var c, u, f, p, a = this, s = i, r = n && n.interval ? n.interval : 1, l = -1 === a.item.enable, h = a.item.min, d = a.item.max, m = l && a.item.disable.filter(function(t) {
                        if (e.isArray(t)) {
                ...
                if ((!n || !n.nav && !n.defaultValue) && (!l && a.disabled(i) || l && a.disabled(i) && (m || c || u) || !l && (i.pick <= h.pick || i.pick >= d.pick)))
                    for (l && !m && (!u && r > 0 || !c && 0 > r) && (r *= -1); a.disabled(i) && (Math.abs(r) > 1 && (i.month < s.month || i.month > s.month) && (i = s,
                        r = r > 0 ? 1 : -1),
                        i.pick <= h.pick ? (f = !0,
                            r = 1,
                            i = a.create([h.year, h.month, h.date + (i.pick === h.pick ? 0 : -1)])) : i.pick >= d.pick && (p = !0,
                            r = -1,
                            i = a.create([d.year, d.month, d.date + (i.pick === d.pick ? 0 : 1)])),
                    !f || !p); )
                        i = a.create([i.year, i.month, i.date + r]);
                return i
            }
            ,
            ...
            a.prototype.isDateOverlap = function(t, i) {
                ...
                return o.isInteger(t) && (o.isDate(i) || e.isArray(i)) ? (t = t % 7 + a,
                t === n.create(i).day + 1) : o.isInteger(i) && (o.isDate(t) || e.isArray(t)) ? (i = i % 7 + a,
                    ...
                    for (l = 0; s > l; l += 1) {
                        ...
                        if (n.isDateOverlap(r, t)) {
                            e.isPlainObject(t) ? (t.inverted = !0,
                                i = t) : e.isArray(t) ? (i = t,
                            i[3] || i.push("inverted")) : o.isDate(t) && (i = [t.getFullYear(), t.getMonth(), t.getDate(), "inverted"]);
                            break
                        }
                    }
                    if (i)
            ...
            a.prototype.nodes = function(t) {
                var e = this
                    ...
                    , f = s.max
                    , p = function(t, e) {
                        return a.firstDay && (t.push(t.shift()),
                            e.push(e.shift())),
                            o.node("thead", o.node("tr", o.group({
                                min: 0,
                                max: i - 1,
                                i: 1,
                                node: "th",
                ...
                return o.node("div", (a.selectYears ? g() + v() : v() + g()) + m() + m(1), a.klass.header) + o.node("table", p + o.node("tbody", o.group({
                            min: 0,
                            max: n - 1,
                            i: 1,
                            node: "tr",
                                ...
                                return [o.group({
                                    ...
                                    item: function(t) {
                                        ...
                                        return [o.node("div", t.date, function(e) {
                                            ...
                                            r.pick == t.pick && e.push(a.klass.now),
                                            i && e.push(a.klass.selected),
                                            n && e.push(a.klass.highlighted),
                                            s && e.push(a.klass.disabled),
                                                e.join(" ")
                            ...
                            readonly: !0
                        })) + o.node("div", o.node("button", a.today, a.klass.buttonToday, "type=button data-pick=" + r.pick + (t && !e.disabled(r) ? "" : " disabled") + " " + o.ariaAttr({
                                controls: e.$node[0].id
    ...
    $.extend($.fn.pickadate.defaults, {
        ...
        onRender: function() {
            ...
            console.log(t, e, i, n),
                $(".picker__header").prepend('<div class="picker__date-display"><div class="picker__weekday-display">' + n + '</div><div class="picker__month-display"><div>' + i + '</div></div><div class="picker__day-display"><div>' + e + '</div></div><div    class="picker__year-display"><div>' + t + "</div></div></div>")
        }
    }),
    function() {
        function h(t) {
        ...
        function C(e, n) {
                ...
                if (!e || !(v - y > p || p > v + y)) {
                    ...
                    o && s.append(E.canvas),
                        ...
                        i.off(c).on(c, function(t) {
                            ...
                            (e || g) && a === d && r === f && E.setHand(a, r),
                                "hours" === E.currentView ? E.toggleView("minutes", w / 2) : n.autoclose && (E.minutesView.addClass("clockpicker-dial-out"),
                                    setTimeout(function() {
                                        E.done()
                                    }, w / 2)),
                                s.prepend(W),
            ...
            if (this.id = p("cp"),
                ...
                n.ampmclickable ? (this.spanAmPm.empty(),
                    ...
                    E.amOrPm = "AM",
                        E.amPmBlock.children(".pm-button").removeClass("active"),
                        E.amPmBlock.children(".am-button").addClass("active"),
                        E.spanAmPm.empty().append("AM")
                }).appendTo(this.amPmBlock),
                    t('<button type="button" class="btn-floating btn-flat clockpicker-button pm-button" tabindex="2">PM</button>').on("click", function() {
                        E.amOrPm = "PM",
                            E.amPmBlock.children(".am-button").removeClass("active"),
                            E.amPmBlock.children(".pm-button").addClass("active"),
                            E.spanAmPm.empty().append("PM")
                    }).appendTo(this.amPmBlock))
            }
            n.darktheme && a.addClass("darktheme"),
                t('<button type="button" class="btn-flat clockpicker-button" tabindex="' + (n.twelvehour ? "3" : "1") + '">' + n.donetext + "</button>").click(t.proxy(this.done, this)).appendTo(this.footer),
                this.spanHours.click(t.proxy(this.toggleView, this, "hours")),
                this.spanMinutes.click(t.proxy(this.toggleView, this, "minutes")),
                T.on("focus.clockpicker click.clockpicker", t.proxy(this.show, this));
            ...
            if (n.twelvehour)
                for (L = 1; 13 > L; L += 1)
                    D = F.clone(),
                        ...
                        D.css("font-size", "140%"),
                        D.css({
                            left: m + Math.sin(R) * z - y,
                            top: m - Math.cos(R) * z - y
                        }),
                        D.html(0 === L ? "00" : L),
                        f.append(D),
                        D.on(r, V);
            ...
            for (L = 0; 60 > L; L += 5)
                D = F.clone(),
                    R = L / 30 * Math.PI,
                    D.css({
                        left: m + Math.sin(R) * v - y,
                        top: m - Math.cos(R) * v - y
                    }),
                    D.css("font-size", "140%"),
                    D.html(d(L)),
                    C.append(D),
            ...
            if (s.on(r, function(e) {
                ...
                var B = h("circle");
                B.setAttribute("class", "clockpicker-canvas-bearing"),
                    B.setAttribute("cx", 0),
                    B.setAttribute("cy", 0),
                    B.setAttribute("r", 2);
                var j = h("line");
        ...
        var t = window.jQuery
            ...
            , o = "SVGAngle"in window && function() {
                    ...
                    return e.innerHTML = "<svg/>",
                        t = (e.firstChild && e.firstChild.namespaceURI) == n,
                        e.innerHTML = "",
                        t
                }()
            , a = function() {
        ...
        C.DEFAULTS = {
            ...
            C.prototype.show = function(n) {
                if (!this.isShown) {
                    ...
                    this.options.twelvehour && (this.amOrPm = "PM",
                        ...
                        e.on("resize.clockpicker" + this.id, function() {
                            o.isShown && o.locate()
                        }),
                        this.isAppended = !0);
                    ...
                    this.hours = +a[0] || 0,
                        this.minutes = +a[1] || 0,
                        this.spanHours.html(d(this.hours)),
                        this.spanMinutes.html(d(this.minutes)),
                        this.toggleView("hours"),
                        this.locate(),
                        this.isShown = !0,
                        i.on("click.clockpicker." + this.id + " focusin.clockpicker." + this.id, function(e) {
                            var i = t(e.target);
            ...
            C.prototype.hide = function() {
                k(this.options.beforeHide),
                    ...
                    this.popover.hide(),
                    k(this.options.afterHide)
            }
            ,
            C.prototype.toggleView = function(e, i) {
                var n = !1;
                "minutes" === e && "visible" === t(this.hoursView).css("visibility") && (k(this.options.beforeHourSelect),
                    n = !0);
                var o = "hours" === e
                ...
                n && k(this.options.afterHourSelect)
            }
            ,
            C.prototype.resetClock = function(t) {
                var e = this.currentView
                    ...
                    , c = -Math.cos(s) * r
                    , u = this;
                o && t ? (u.canvas.addClass("clockpicker-canvas-out"),
                    setTimeout(function() {
            ...
            C.prototype.setHand = function(e, i, n, a) {
                var m, s = Math.atan2(e, -i), r = "hours" === this.currentView, l = Math.PI / (r || n ? 6 : 30), c = Math.sqrt(e * e + i * i), h = this.options, f = r && (v + g) / 2 > c, p = f ? g : v;
                if (h.twelvehour && (p = v),
                    0 > s && (s = 2 * Math.PI + s),
                        m = Math.round(s / l),
                        s = m * l,
                        h.twelvehour ? r ? 0 === m && (m = 12) : (n && (m *= 5),
                        60 === m && (m = 0)) : r ? (12 === m && (m = 0),
                            m = f ? 0 === m ? 12 : m : 0 === m ? 0 : m + 12) : (n && (m *= 5),
                        60 === m && (m = 0)),
                        r ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : m % 5 == 0 ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : this.fg.setAttribute("class", "clockpicker-canvas-fg active"),
                    this[this.currentView] !== m && u && this.options.vibrate && (this.vibrateTimer || (navigator[u](10),
                        this.vibrateTimer = setTimeout(t.proxy(function() {
                            this.vibrateTimer = null
                        }, this), 100))),
                        this[this.currentView] = m,
                        this[r ? "spanHours" : "spanMinutes"].html(d(m)),
                        !o)
                    return void this[r ? "hoursView" : "minutesView"].find(".clockpicker-tick").each(function() {
                        var e = t(this);
                        e.toggleClass("active", m === +e.html())
                    });
                a || !r && m % 5 ? (this.g.insertBefore(this.hand, this.bearing),
            ...
            C.prototype.remove = function() {
                ...
                this.isAppended && (e.off("resize.clockpicker" + this.id),
                    this.popover.remove())
            }
            ,
            t.fn.pickatime = function(e) {
                ...
                return this.each(function() {
                    ...
                    if (o)
                        "function" == typeof o[e] && o[e].apply(o, i);
                    else {
    ...
    !function(t, e) {
        ...
        var t = function(t, e, i, n) {
            ...
            o.features.oldIE && (o.bind = function(t, e, i, n) {
                    e = e.split(" ");
                    for (var o, a = (n ? "detach" : "attach") + "Event", s = function() {
            ...
            var c, u, h, d, f, p, m, v, g, y, b, w, x, C, k, S, P, T, A, E, M, I, O, F, L, D, R, z, _, V, W, H, N, B, j, $, q, Y, X, Q, Z, G, U, K, J, tt, et, it, nt, ot, at, st, rt, lt, ct, ut, ht = function() {
            ...
            }, dt = ht(), ft = ht(), pt = ht(), mt = {}, vt = 0, gt = {}, yt = ht(), bt = 0, wt = !0, xt = [], Ct = {}, kt = !1, St = function(t, e) {
                ...
                lt = t,
                    a.bg.style.opacity = t * l.bgOpacity
            }, Ot = function(t, e, i, n, o) {
                (!kt || o && o !== a.currItem) && (n /= o ? o.fitRatio : a.currItem.fitRatio),
                    t[I] = w + e + "px, " + i + "px" + x + " scale(" + n + ")"
            }, Ft = function(t) {
                nt && (t && (y > a.currItem.fitRatio ? kt || (hi(a.currItem, !1, !0),
                    kt = !0) : kt && (hi(a.currItem),
                    kt = !1)),
                    Ot(nt, pt.x, pt.y, y))
            }, Lt = function(t) {
                ...
                Wt && (o.unbind(document, "mousemove", Ht),
                ...
                t && (Z || Q || ot || $) && (t.preventDefault(),
                    t.stopPropagation())
            }, Gt = function() {
                a.setScrollOffset(0, o.getScrollY())
            }, Ut = {}, Kt = 0, Jt = function(t) {
                Ut[t] && (Ut[t].raf && D(Ut[t].raf),
                    Kt--,
                    delete Ut[t])
            }, te = function(t) {
                Ut[t] && Jt(t),
                ...
                init: function() {
                    if (!c && !u) {
                        ...
                        for (W.animationName && W.transform && !n || (l.showAnimationDuration = l.hideAnimationDuration = 0),
                                 i = 0; i < xt.length; i++)
                            a["init" + xt[i]]();
                        if (e) {
                        ...
                        Et("firstUpdate"),
                            d = d || l.index || 0,
                        (isNaN(d) || 0 > d || d >= Je()) && (d = 0),
                            a.currItem = Ke(d),
                        (W.isOldIOSPhone || W.isOldAndroid) && (wt = !1),
                            t.setAttribute("aria-hidden", "false"),
                        l.modal && (wt ? t.style.position = "fixed" : (t.style.position = "absolute",
                            t.style.top = o.getScrollY() + "px")),
                        void 0 === V && (Et("initialLayout"),
                            V = z = o.getScrollY());
                        var h = "pswp--open ";
                        for (l.mainClass && (h += l.mainClass + " "),
                             l.showHideOpacity && (h += "pswp--animate_opacity "),
                                 h += F ? "pswp--touch" : "pswp--notouch",
                                 h += W.animationName ? " pswp--css_animation" : "",
                                 h += W.svg ? " pswp--svg" : "",
                                 o.addClass(t, h),
                                 a.updateSize(),
                                 p = -1,
                                 bt = null,
                                 i = 0; r > i; i++)
                            Dt((i + p) * yt.x, S[i].el.style);
                        _ || o.bind(a.scrollWrap, v, a),
                            ...
                            a.updateCurrItem(),
                            Et("afterInit"),
                        wt || (C = setInterval(function() {
                            Kt || Y || J || y !== a.currItem.initialZoomLevel || a.updateSize()
                        }, 1e3)),
                ...
                close: function() {
                    c && (c = !1,
                        ...
                        Et("close"),
                        Bt(),
                        ei(a.currItem, null, !0, a.destroy))
                },
                destroy: function() {
                    Et("destroy"),
                    Qe && clearTimeout(Qe),
                ...
                panTo: function(t, e, i) {
                    i || (t > it.min.x ? t = it.min.x : t < it.max.x && (t = it.max.x),
                        e > it.min.y ? e = it.min.y : e < it.max.y && (e = it.max.y)),
                        pt.x = t,
                        pt.y = e,
                        Ft()
                },
                        ...
                        if (!(t && 2 > i)) {
                            ...
                            for (var n = 0; i > n; n++)
                                bt > 0 ? (e = S.shift(),
                                    S[r - 1] = e,
                                    p++,
                                    Dt((p + 2) * yt.x, e.el.style),
                                    a.setContent(e, d - i + n + 1 + 1)) : (e = S.pop(),
                                    S.unshift(e),
                                    p--,
                                    Dt(p * yt.x, e.el.style),
                                    a.setContent(e, d + i - n - 1 - 1));
                            if (nt && 1 === Math.abs(bt)) {
                                var o = Ke(P);
                                o.initialZoomLevel !== y && (ri(o, mt),
                                    hi(o),
                                    Lt(o))
                            }
                            bt = 0,
                ...
                updateSize: function(e) {
                    if (!wt && l.modal) {
                        var i = o.getScrollY();
                        if (V !== i && (t.style.top = i + "px",
                                V = i),
                            !e && Ct.x === window.innerWidth && Ct.y === window.innerHeight)
                            return;
                        Ct.x = window.innerWidth,
                            Ct.y = window.innerHeight,
                            t.style.height = Ct.y + "px"
                    }
                    if (mt.x = a.scrollWrap.clientWidth,
                            mt.y = a.scrollWrap.clientHeight,
                            Gt(),
                            yt.x = mt.x + Math.round(mt.x * l.spacing),
                            yt.y = mt.y,
                            Rt(yt.x * vt),
                            Et("beforeResize"),
                        void 0 !== p) {
                        for (var n, s, c, u = 0; r > u; u++)
                            n = S[u],
                                Dt((u + p) * yt.x, n.el.style),
                                c = d + u - 1,
                            l.loop && Je() > 2 && (c = Pt(c)),
                                s = Ke(c),
                                s && (k || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s),
                                    a.setContent(n, c),
                                1 === u && (a.currItem = s,
                                    a.updateCurrZoomItem(!0)),
                                    s.needsUpdate = !1) : -1 === n.index && c >= 0 && a.setContent(n, c),
                            s && s.container && (ri(s, mt),
                                hi(s),
                                Lt(s));
                        k = !1
                    }
                ...
                zoomTo: function(t, e, i, n, a) {
                    e && (b = y,
                        be.x = Math.abs(e.x) - pt.x,
                        be.y = Math.abs(e.y) - pt.y,
                        _t(ft, pt));
                    var s = jt(t, !1)
                        , r = {};
                    Yt("x", s, r, t),
            ...
            }, oe = 30, ae = 10, se = {}, re = {}, le = {}, ce = {}, ue = {}, he = [], de = {}, fe = [], pe = {}, me = 0, ve = ht(), ge = 0, ye = ht(), be = ht(), we = ht(), xe = function(t, e) {
                return t.x === e.x && t.y === e.y
            }, Ce = function(t, e) {
                return Math.abs(t.x - e.x) < s && Math.abs(t.y - e.y) < s
            }, ke = function(t, e) {
                return pe.x = Math.abs(t.x - e.x),
                    pe.y = Math.abs(t.y - e.y),
                    Math.sqrt(pe.x * pe.x + pe.y * pe.y)
            }, Se = function() {
                G && (D(G),
                    G = null)
            }, Pe = function() {
                ...
                return Ee.prevent = !Ae(t.target, l.isClickableElement),
                    Et("preventDragEvent", t, e, Ee),
                    Ee.prevent
            }, Ie = function(t, e) {
                return e.x = t.pageX,
                    e.y = t.pageY,
            ...
            }, De = {}, Re = {}, ze = [], _e = function(t) {
                for (; ze.length > 0; )
                    ze.pop();
                return O ? (ut = 0,
                    he.forEach(function(t) {
                        0 === ut ? ze[0] = t : 1 === ut && (ze[1] = t),
                            ut++
                    })) : t.type.indexOf("touch") > -1 ? t.touches && t.touches.length > 0 && (ze[0] = Ie(t.touches[0], De),
                t.touches.length > 1 && (ze[1] = Ie(t.touches[1], Re))) : (De.x = t.pageX,
                    De.y = t.pageY,
                    De.id = "",
                    ze[0] = De),
                    ze
            }, Ve = function(t, e) {
                var i, n, o, s, r = 0, c = pt[t] + e[t], u = e[t] > 0, h = ye.x + e.x, d = ye.x - de.x;
                return i = c > it.min[t] || c < it.max[t] ? l.panEndFriction : 1,
                    c = pt[t] + e[t] * i,
                    !l.allowPanToNext && y !== a.currItem.initialZoomLevel || (nt ? "h" !== at || "x" !== t || Q || (u ? (c > it.min[t] && (i = l.panEndFriction,
                        r = it.min[t] - c,
                        n = it.min[t] - ft[t]),
                        (0 >= n || 0 > d) && Je() > 1 ? (s = h,
                        0 > d && h > de.x && (s = de.x)) : it.min.x !== it.max.x && (o = c)) : (c < it.max[t] && (i = l.panEndFriction,
                        r = c - it.max[t],
                        n = ft[t] - it.max[t]),
                        (0 >= n || d > 0) && Je() > 1 ? (s = h,
                        d > 0 && h < de.x && (s = de.x)) : it.min.x !== it.max.x && (o = c))) : s = h,
                    "x" !== t) ? void (ot || U || y > a.currItem.fitRatio && (pt[t] += e[t] * i)) : (void 0 !== s && (Rt(s, !0),
                        U = s === de.x ? !1 : !0),
                    it.min.x !== it.max.x && (void 0 !== o ? pt.x = o : U || (pt.x += e.x * i)),
                    void 0 !== s)
            }, We = function(t) {
                if (!("mousedown" === t.type && t.button > 0)) {
                    ...
                    if (!q || "mousedown" !== t.type) {
                        ...
                        !J && n > 1 && !ot && !U && (b = y,
                            ...
                            _t(re, i[1]),
                            Oe(se, re, we),
                            be.x = Math.abs(we.x) - pt.x,
                            be.y = Math.abs(we.y) - pt.y,
                            tt = et = ke(se, re))
                    }
                }
            }, He = function(t) {
                    ...
                    if (0 !== t)
                        if (_t(se, K[0]),
                            ...
                            if (!at)
                                return;
                            if (st && (st = !1,
                                Math.abs(le.x) >= ae && (le.x -= K[0].x - ue.x),
                                Math.abs(le.y) >= ae && (le.y -= K[0].y - ue.y)),
                                    ce.x = se.x,
                                    ce.y = se.y,
                                0 === le.x && 0 === le.y)
                                return;
                ...
                if (W.isOldAndroid) {
                    if (q && "mouseup" === t.type)
                        return;
                    t.type.indexOf("touch") > -1 && (clearTimeout(q),
                ...
                var s, r = _e(t), c = r.length;
                if ("mouseup" === t.type && (c = 0),
                    2 === c)
                    return K = null,
                        !0;
                1 === c && _t(ue, r[0]),
                0 !== c || at || ot || (e || ("mouseup" === t.type ? e = {
                    x: t.pageX,
                    y: t.pageY,
                    type: "mouse"
                    ...
                    if (ee(),
                        ...
                        if (h < l.verticalDragRange)
                            ...
                            ie("verticalDrag", 0, 1, 300, o.easing.cubic.out, function(t) {
                                pt.y = (a.currItem.initialPosition.y - d) * t + d,
                                    It((1 - f) * t + f),
                                    Ft()
                            }),
                                Et("onVerticalDrag", 1)
                        ...
                        if (!ot)
                            return "swipe" !== s ? void Xe() : void (!U && y > a.currItem.fitRatio && $e(B))
                    }
            }, je = function() {
                var t, e, i = {
                    lastFlickOffset: {},
                    ...
                    calculateSwipeSpeed: function(n) {
                        fe.length > 1 ? (t = Mt() - N + 50,
                            e = fe[fe.length - 2][n]) : (t = Mt() - H,
                            e = ue[n]),
                    ...
                    calculateOverBoundsAnimOffset: function(t, e) {
                        i.backAnimStarted[t] || (pt[t] > it.min[t] ? i.backAnimDestination[t] = it.min[t] : pt[t] < it.max[t] && (i.backAnimDestination[t] = it.max[t]),
                        void 0 !== i.backAnimDestination[t] && (i.slowDownRatio[t] = .7,
                            i.slowDownRatioReverse[t] = 1 - i.slowDownRatio[t],
                        i.speedDecelerationRatioAbs[t] < .05 && (i.lastFlickSpeed[t] = 0,
                            i.backAnimStarted[t] = !0,
                            ie("bounceZoomPan" + t, pt[t], i.backAnimDestination[t], e || 300, o.easing.sine.out, function(e) {
                                pt[t] = e,
                                    Ft()
                            }))))
                    },
                    ...
                    panAnimLoop: function() {
                        return Ut.zoomPan && (Ut.zoomPan.raf = L(i.panAnimLoop),
                            i.now = Mt(),
                        ...
                        i.speedDecelerationRatioAbs.x < .05 && i.speedDecelerationRatioAbs.y < .05) ? (pt.x = Math.round(pt.x),
                            pt.y = Math.round(pt.y),
                            Ft(),
                            void Jt("zoomPan")) : void 0
                    }
                };
                return i
            }, $e = function(t) {
                ...
                n && (d += n,
                    0 > d ? (d = l.loop ? Je() - 1 : 0,
                        c = !0) : d >= Je() && (d = l.loop ? 0 : Je() - 1,
                        c = !0),
                (!c || l.loop) && (bt += n,
                    vt -= n,
                    i = !0));
                var u, h = yt.x * vt, f = Math.abs(h - ye.x);
                return i || h > ye.x == e.lastFlickSpeed.x > 0 ? (u = Math.abs(e.lastFlickSpeed.x) > 0 ? f / Math.abs(e.lastFlickSpeed.x) : 333,
                    u = Math.min(u, 400),
                    u = Math.max(u, 250)) : u = 333,
                me === d && (i = !1),
                    ot = !0,
                    Et("mainScrollAnimStart"),
                    ie("mainScroll", ye.x, h, u, o.easing.cubic.out, Rt, function() {
                        ee(),
                            ot = !1,
                            me = -1,
                        (i || me !== d) && a.updateCurrItem(),
            ...
            St("Gestures", {
                publicMethods: {
                    initGestures: function() {
                        ...
                        O = W.pointerEvent,
                        O && W.touch && (W.touch = !1),
                            O ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : W.touch ? (t("touch", "start", "move", "end", "cancel"),
                                F = !0) : t("mouse", "down", "move", "up"),
                            m = A + " " + E + " " + M,
                            v = T,
                        O && !F && (F = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1),
            ...
            var Qe, Ze, Ge, Ue, Ke, Je, ti, ei = function(e, i, n, s) {
                Qe && clearTimeout(Qe),
                    ...
                    Ge = !0;
                var r;
                e.initialLayout ? (r = e.initialLayout,
                    e.initialLayout = null) : r = l.getThumbBoundsFn && l.getThumbBoundsFn(d);
                var c = n ? l.hideAnimationDuration : l.showAnimationDuration
                    , u = function() {
                        Jt("initialZoom"),
                            n ? (a.template.removeAttribute("style"),
                                a.bg.removeAttribute("style")) : (It(1),
                            ...
                            if (Et("initialZoom" + (n ? "Out" : "In")),
                                ...
                                var a = r.w / e.w
                                    ...
                                    , f = function(e) {
                                        1 === e ? (y = a,
                                            pt.x = r.x,
                                            pt.y = r.y - V) : (y = (a - h) * e + h,
                                            pt.x = (r.x - l.x) * e + l.x,
                                            pt.y = (r.y - V - l.y) * e + l.y),
                                            Ft(),
                                            s ? t.style.opacity = 1 - e : It(d - e * d)
                                    };
                                i ? ie("initialZoom", 0, 1, c, o.easing.cubic.out, f, u) : (f(1),
                ...
                var n = t.bounds;
                n.center.x = Math.round((ii.x - e) / 2),
                    n.center.y = Math.round((ii.y - i) / 2) + t.vGap.top,
                    n.max.x = e > ii.x ? Math.round(ii.x - e) : n.center.x,
                    n.max.y = i > ii.y ? Math.round(ii.y - i) + t.vGap.top : n.center.y,
                    n.min.x = e > ii.x ? 0 : n.center.x,
                    n.min.y = i > ii.y ? t.vGap.top : n.center.y
            }, ri = function(t, e, i) {
                if (t.src && !t.loadError) {
                    ...
                    if (n && (t.vGap || (t.vGap = {
                            ...
                            ii.x = e.x,
                            ii.y = e.y - t.vGap.top - t.vGap.bottom,
                            n) {
                        var o = ii.x / t.w
                            , a = ii.y / t.h;
                        t.fitRatio = a > o ? o : a;
                        ...
                        t.bounds || (t.bounds = ai())
                    }
                    if (!i)
                        return;
                    return si(t, t.w * i, t.h * i),
                ...
                return t.w = t.h = 0,
                    ...
                    t.bounds
            }, li = function(t, e, i, n, o, s) {
                e.loadError || n && (e.imageAppended = !0,
                    hi(e, n, e === a.currItem && kt),
                    i.appendChild(n),
                ...
                if (ni.length) {
                    for (var t, e = 0; e < ni.length; e++)
                        t = ni[e],
                        t.holder.index === t.index && li(t.index, t.item, t.baseDiv, t.img, !1, t.clearPlaceholder);
                    ni = []
                }
            };
            St("Controller", {
                publicMethods: {
                    lazyLoadItem: function(t) {
                        t = Pt(t);
                        var e = Ke(t);
                        e && (!e.loaded && !e.loading || k) && (Et("gettingData", t, e),
                        e.src && ci(e))
                    },
                    initController: function() {
                        ...
                        Je() < 3 && (l.loop = !1),
                            At("beforeChange", function(t) {
                                var e, i = l.preload, n = null === t ? !0 : t >= 0, o = Math.min(i[0], Je()), s = Math.min(i[1], Je());
                                for (e = 1; (n ? s : o) >= e; e++)
                                    a.lazyLoadItem(d + e);
                                for (e = 1; (n ? o : s) >= e; e++)
                                    a.lazyLoadItem(d - e)
                            ...
                            At("mainScrollAnimComplete", di),
                            At("initialZoomInEnd", di),
                            At("destroy", function() {
                    ...
                    setContent: function(t, e) {
                        ...
                        if (!s.src && s.html && (s.html.tagName ? r.appendChild(s.html) : r.innerHTML = s.html),
                            ...
                            s.src && !s.loadError && (n = o.createEl("pswp__img", "img"),
                                n.style.opacity = 1,
                                n.src = s.src,
                                hi(s, n),
                                li(e, s, r, n, !0));
                                        ...
                                        if (t && t.index === e) {
                                            if (ui(i, !0))
                                                return i.loadComplete = i.img = null,
                                                    ri(i, mt),
                                                    Lt(i),
                                                    void (t.index === d && a.updateCurrZoomItem());
                                            i.imageAppended ? !Ue && i.placeholder && (i.placeholder.style.display = "none",
                                                i.placeholder = null) : W.transform && (ot || Ue) ? ni.push({
                                                item: i,
                                                baseDiv: r,
                                                img: i.img,
                                                index: e,
                            ...
                            s.loading || ci(s),
                            a.allowProgressiveImg() && (!Ge && W.transform ? ni.push({
                                item: s,
                                baseDiv: r,
                                img: s.img,
                                index: e,
            ...
            St("Tap", {
                publicMethods: {
                    initTap: function() {
                        At("firstTouchStart", a.onTapStart),
                            At("touchRelease", a.onTapRelease),
                            At("destroy", function() {
                                pi = {},
                                    fi = null
                            })
                    ...
                    onTapStart: function(t) {
                        t.length > 1 && (clearTimeout(fi),
                            fi = null)
                    },
                    onTapRelease: function(t, e) {
                        if (e && !Z && !X && !Kt) {
                            var i = e;
                            if (fi && (clearTimeout(fi),
                                    fi = null,
                                    Ce(i, pi)))
                ...
                publicMethods: {
                    ...
                    setupDesktopZoom: function(e) {
                        ...
                        At("bindEvents", function() {
                            ...
                            At("unbindEvents", function() {
                                vi && o.unbind(t, i, a.handleMouseWheel)
                            }),
                            a.mouseZoomedIn = !1;
                        var n, s = function() {
                            a.mouseZoomedIn && (o.removeClass(t, "pswp--zoomed-in"),
                                a.mouseZoomedIn = !1),
                                1 > y ? o.addClass(t, "pswp--zoom-allowed") : o.removeClass(t, "pswp--zoom-allowed"),
                                r()
                        }, r = function() {
                    ...
                    handleMouseWheel: function(t) {
                        if (y <= a.currItem.fitRatio)
                            return l.modal && (!l.closeOnScroll || Kt || Y ? t.preventDefault() : I && Math.abs(t.deltaY) > 2 && (h = !0,
                                a.close())),
                                !0;
                        ...
                        var e = pt.x - vi.x
                            , i = pt.y - vi.y;
                        (l.modal || e <= it.min.x && e >= it.max.x && i <= it.min.y && i >= it.max.y) && t.preventDefault(),
                            a.panTo(e, i)
                    },
            ...
            var gi, yi, bi, wi, xi, Ci, ki, Si, Pi, Ti, Ai, Ei, Mi = {
                history: !0,
                galleryUID: 1
            }, Ii = function() {
                ...
                Ei ? "#" + i !== window.location.hash && history[Si ? "replaceState" : "pushState"]("", document.title, n) : Si ? Ai.replace(n) : Ai.hash = i,
                    Si = !0,
                ...
                publicMethods: {
                    initHistory: function() {
                        if (o.extend(l, Mi, !0),
                            ...
                            ki.indexOf("gid=") > -1 && (ki = ki.split("&gid=")[0],
                                ki = ki.split("?gid=")[0]),
                                At("afterChange", a.updateURL),
                                At("unbindEvents", function() {
                                    o.unbind(window, "hashchange", a.onHashChange)
                                });
                            var t = function() {
                                Ci = !0,
                                Pi || (Ti ? history.back() : ki ? Ai.hash = ki : Ei ? history.pushState("", document.title, Ai.pathname + Ai.search) : Ai.hash = ""),
                                    Oi()
                            };
                            At("unbindEvents", function() {
                                h && t()
                            ...
                            e > -1 && (ki = ki.substring(0, e),
                            "&" === ki.slice(-1) && (ki = ki.slice(0, -1))),
                                setTimeout(function() {
    ...
    !function(t, e) {
        ...
        "use strict";
        var t = function(t, e) {
            var i, n, o, a, s, r, l, c, u, h, d, f, p, m, v, g, y, b, w, x = this, C = !1, k = !0, S = !0, P = {
                barsSize: {
                    top: 44,
                    bottom: "auto"
                },
                ...
                if (g)
                    return !0;
                t = t || window.event,
                v.timeToIdle && v.mouseUsed && !u && z();
                for (var i, n, o = t.target || t.srcElement, a = o.getAttribute("class") || "", s = 0; s < $.length; s++)
                    i = $[s],
                ...
                t !== m && (E(n, "ui--one-slide", t),
                    m = t)
            }, I = function() {
                E(l, "share-modal--hidden", S)
            }, O = function() {
                return S = !S,
                    S ? (e.removeClass(l, "pswp__share-modal--fade-in"),
                        setTimeout(function() {
                            S && I()
                        }, 300)) : (I(),
                        setTimeout(function() {
                ...
                for (var t, e, i, n, o, a = "", s = 0; s < v.shareButtons.length; s++)
                    t = v.shareButtons[s],
                        i = v.getImageURLForShare(t),
                        n = v.getPageURLForShare(t),
                        o = v.getTextForShare(t),
                        ...
                        a += '<a href="' + e + '" target="_blank" class="pswp__share--' + t.id + '"' + (t.download ? "download" : "") + ">" + t.label + "</a>",
                    v.parseShareButtonOut && (a = v.parseShareButtonOut(t, a));
                ...
                v.fullscreenEl && !e.features.isOldAndroid && (i || (i = x.getFullscreenAPI()),
                    ...
                    if (n)
                        for (var a = n.length, s = 0; a > s; s++) {
                            ...
                            for (var r = 0; r < $.length; r++)
                                o = $[r],
                                i.indexOf("pswp__" + o.name) > -1 && (v[o.option] ? (e.removeClass(t, "pswp__element--disabled"),
            ...
            x.init = function() {
                ...
                x.update = function() {
                    ...
                    v.captionEl && (v.addCaptionHTMLFn(t.currItem, o),
                ...
                x.onGlobalTap = function(i) {
                    ...
                    if (!g)
                        ...
                        } else if (v.tapToToggleControls && (k ? x.hideControls() : x.showControls()),
                            v.tapToClose && (e.hasClass(n, "pswp__img") || D(n)))
                            return void t.close()
                }
                ,
...
var initPhotoSwipeFromDOM = function(t) {
    for (var e = function(t) {
        for (var o, a, s, r, e = t.childNodes, i = e.length, n = [], l = 0; i > l; l++)
            o = e[l],
            1 === o.nodeType && (a = o.children[0],
                s = a.getAttribute("data-size").split("x"),
                r = {
                    src: a.getAttribute("href"),
                    w: parseInt(s[0], 10),
                    h: parseInt(s[1], 10)
                },
            o.children.length > 1 && (r.title = o.children[1].innerHTML),
            a.children.length > 0 && (r.msrc = a.children[0].getAttribute("src")),
                r.el = o,
                n.push(r));
        return n
    }, i = function u(t, e) {
        ...
        isNaN(r.index) || (n && (r.showAnimationDuration = 0),
            s = new PhotoSwipe(a,PhotoSwipeUI_Default,l,r),
            s.init())
    }, s = document.querySelectorAll(t), r = 0, l = s.length; l > r; r++)
        s[r].setAttribute("data-pswp-uid", r + 1),
            s[r].onclick = n;
    var c = o();
