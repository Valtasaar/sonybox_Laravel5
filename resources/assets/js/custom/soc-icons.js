...
(function($) {
    $(function() {
        $('div.share42init').each(function(idx) {
            ...
            var l = '';
            for (j = 0; j < s.length; j++) l += '<span class="share42-item soc_hover" style="display:inline-block;height:57px;"><a rel="nofollow" style="display:inline-block;width:54px;height:57px;margin:0;padding:0;outline:none;background:url(' + fn + ') -' + 60 * j + 'px 0 no-repeat" href=' + s[j] + ' target="_blank"></a></span>';
